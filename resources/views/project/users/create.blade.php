...
@section('title', __('users-create.create-user'))
    ...
    <section class="users-edit">
        <div class="card">
            <div class="card-content">
                <div class="card-body">
                    @include('project.users.form-create-edit', ['action' => route('user.store')])
                </div>
            </div>
        </div>
    </section>
...
@section('page-script')
    <!-- Page js files -->
    <script src="{{ asset(mix('assets/js/project/users/create.js')) }}"></script>
    <!-- Dropify JS -->

...
<?php $__env->startSection('title', __('global.edit_chapter')); ?>
    ...
    <section class="chapter-edit">
        <div class="card">
            <div class="card-content">
                <div class="card-body">
                    <?php echo $__env->make('chapter.create-edit-form', ['action' => route('chapter.update', ['chapter' => $chapter]), 'chapter' => $chapter], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
        </div>
    </section>
...
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laragon\www\gestion_de_calidad\resources\views/chapter/edit.blade.php ENDPATH**/ ?>
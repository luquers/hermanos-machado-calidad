<form id="create-procedure" method="post" action="<?php echo e($action); ?>" novalidate>
    <?php echo csrf_field(); ?>
    <?php echo e(isset($procedure) ? method_field('put') : ''); ?>

    <div class="row">
    <?php if (isset($component)) { $__componentOriginal942cbedc8524995abeccadc00a91f89c8cb356bd = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Inputs\Text::class, ['col' => 'col-12 col-lg-6','name' => 'code','label' => 'global.code','id' => 'code','value' => ''.e(old('code', $procedure->code ?? '')).'']); ?>
...
<?php endif; ?>
    ...
    <?php if (isset($component)) { $__componentOriginal942cbedc8524995abeccadc00a91f89c8cb356bd = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Inputs\Text::class, ['col' => 'col-12 col-lg-6','name' => 'name','label' => 'global.name','id' => 'name','value' => ''.e(old('name', $procedure->name ?? '')).'']); ?>
<?php $component->withName('inputs.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\Textareas\Textarea::class, ['col' => 'col-12 col-lg-6','rows' => '6','label' => 'global.description','name' => 'description','value' => ''.e(old('description', $procedure->description ?? '')).'']); ?>
...
</form><?php /**PATH F:\laragon\www\gestion_de_calidad\resources\views/procedure/create-edit-form.blade.php ENDPATH**/ ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\Selects\Basic::class, ['col' => 'col-12 col-lg-4','options' => $select,'label' => 'global.select_status','optionValue' => 'id','display' => 'name','id' => 'users_softDelete','name' => 'users_softDelete']); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\Inputs\Text::class, ['col' => 'col-12 col-lg-4','name' => 'name','label' => 'global.name','id' => 'name']); ?>
...
<?php endif; ?>
<?php if (isset($component)) { $__componentOriginal942cbedc8524995abeccadc00a91f89c8cb356bd = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Inputs\Text::class, ['col' => 'col-12 col-lg-4','name' => 'email','label' => 'global.email','id' => 'email']); ?>
<?php $component->withName('inputs.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
...
<?php endif; ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?><?php /**PATH F:\laragon\www\gestion_de_calidad\resources\views/project/users/filters.blade.php ENDPATH**/ ?>
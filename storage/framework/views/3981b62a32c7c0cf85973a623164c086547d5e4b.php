...
<?php $__env->startSection('title', __('global.create_procedure')); ?>
    ...
    <section class="procedure-edit">
        <div class="card">
            <div class="card-content">
                <div class="card-body">
                    <?php echo $__env->make('procedure.create-edit-form', ['action' => route('procedure.store', $chapter)], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
        </div>
    </section>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laragon\www\gestion_de_calidad\resources\views/procedure/create.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('title', __('users-edit.edit-user')); ?>
    ...
    <section class="users-edit">
        <div class="card">
            <div class="card-content">
                <div class="card-body">
                    <?php echo $__env->make('project.users.form-create-edit', ['action' => route('user.update', ['user' => $user]), 'user' => $user], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
        </div>
    </section>
...
<?php $__env->startSection('page-script'); ?>
    <!-- Page js files -->
    <script src="<?php echo e(asset(mix('assets/js/project/users/edit.js'))); ?>"></script>
    <!-- Dropify JS -->
...
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laragon\www\gestion_de_calidad\resources\views/project/users/edit.blade.php ENDPATH**/ ?>
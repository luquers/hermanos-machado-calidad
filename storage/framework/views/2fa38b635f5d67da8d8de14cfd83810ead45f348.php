...
<?php $__env->startSection('title', __('global.chapter') . ' ' . $chapter->name . ' - ' . __('global.procedure_list')); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="procedure-edit">
        <div class="card">
            <div class="card-content">
                <div class="card-body">
                        <div class="row">
                            <?php if(!Auth::user()->hasRole('user')): ?>
                                 <a class="btn btn-xs btn-info m-2" href="<?php echo e(route('procedure.create', $chapter)); ?>"><?php echo e(__("global.add_procedure")); ?></a>
                            <?php endif; ?>
                            <?php echo $__env->make('procedure.filters', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
...
<?php $__env->startSection('page-script'); ?>
    ...
    <script>
        $('#code, #name').donetyping(function() {
            window.LaravelDataTables['procedure-table'].draw();
        });

        $('#procedure-table').on('click', '.delete-procedure', function () {
...
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laragon\www\gestion_de_calidad\resources\views/procedure/index.blade.php ENDPATH**/ ?>
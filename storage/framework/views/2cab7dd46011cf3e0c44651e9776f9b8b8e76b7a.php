...
<?php $__env->startSection('title', __('global.document') . ' ' . $document->name . ' - ' . __('global.version_list')); ?>
                ...
                <div class="card-body">
                        ...
                        <div class="row">
                            <?php if(!Auth::user()->hasRole('user')): ?>
                                <a class="btn btn-xs btn-info m-2" href="<?php echo e(route('version.create', $document)); ?>"><?php echo e(__("global.add_version")); ?></a>
                            <?php endif; ?>
                                <?php echo $__env->make('version.filters', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
...
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laragon\www\gestion_de_calidad\resources\views/version/index.blade.php ENDPATH**/ ?>
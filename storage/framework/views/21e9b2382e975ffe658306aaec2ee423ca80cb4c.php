...
<?php $__env->startSection('title', __('global.edit_document')); ?>
    ...
    <section class="document-edit">
        <div class="card">
            <div class="card-content">
                <div class="card-body">
                    <?php echo $__env->make('document.create-edit-form', ['action' => route('document.update', ['document' => $document]), 'document' => $document], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
        </div>
    </section>
...
<?php echo $__env->make('layouts.contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laragon\www\gestion_de_calidad\resources\views/document/edit.blade.php ENDPATH**/ ?>